            ...
            <FeatureSection title="Account Security" icon="security" iconClassName="text-purple-600">
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-purple-50 border border-purple-100 rounded-lg">
                        <div>
                            <h4 className="font-medium text-purple-900">Two-Factor Authentication</h4>
                            <p className="text-sm text-purple-700/80">Add an extra layer of security to your account</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            ...
                            />
                            <div className="w-11 h-6 bg-purple-200 rounded-full peer peer-disabled:opacity-50">
                                <div className="w-5 h-5 bg-white border border-purple-300 rounded-full mt-0.5 ml-0.5"></div>
                            </div>
                        </label>
                    </div>
