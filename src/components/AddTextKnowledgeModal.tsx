...
interface AddTextKnowledgeModalProps {
    onClose: () => void;
...
const AddTextKnowledgeModal: React.FC<AddTextKnowledgeModalProps> = ({ onClose, onSave }) => {
    ...
    const titleNode = (
        <div className="flex items-center gap-3">
            <span className="material-symbols-outlined w-6 h-6 text-primary-600">article</span>
            <h3 className="text-xl font-bold text-slate-800">Add Text Knowledge</h3>
        </div>
    );
                ...
                <div className="p-6 space-y-4">
                    <div>
                        ...
                        <Input
                            type="text"
                            id="knowledge-title"
                            placeholder="e.g., Common HOA Questions"
                            value={title}
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            rows={8}
                            placeholder="Paste text snippets, frequently asked questions, or any other information for the AI to learn."
                            value={content}
...
export default AddTextKnowledgeModal;
