...
const TodayDashboardPage: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 md:px-8">
      ...
      {!demoMode && !blueprintMode && (
        <section className="rounded-3xl border border-slate-200 bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.14),_transparent_42%),linear-gradient(135deg,#0f172a_0%,#111827_55%,#1e293b_100%)] p-6 text-white shadow-sm">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-cyan-300">Sales Demo</p>
              <h2 className="mt-2 text-2xl font-bold">Show exactly what one listing becomes.</h2>
              <p className="mt-2 text-sm text-slate-300">
                Open one finished demo and walk through the live property page, tracked QR, buyer report, seller pricing report, print assets, and social assets.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-xl border border-slate-600 bg-slate-900/40 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-900/70"
              >
